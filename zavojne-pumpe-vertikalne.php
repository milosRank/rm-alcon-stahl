...
<head>
    ...
    <title>Zavojne pumpe - vertikalne | RM Alcon Stahl</title>
                    ...
                    <div class="container-fluid">
                        <div class="wrapper">
                            <div class="container container-medium-narrow">
                                ...
                                <!-- Section decoration -->
                                <img class="decoration zavojne-vertikalne-pumpe" src="assets/img/decorations/decoration--zavojne-pumpe-vertikalne.webp" alt="Verikalne zavojne pumpe" width="193" height="362">

                                <!-- Text and heading inner start -->
                                <div class="text-and-heading__inner">

                                    <div class="title">
                                        <h1>Zavojne pumpe - vertikalne</h1>    
                                    </div>
                                ...
                                <div class="table-and-image__inner">
                                    ...
                                    <div class="image-container">
                                        <div class="image-box shadow">
                                            <img width="240" 
                                                height="240" 
                                                src="assets/img/pump-list/vertikalne/zavojna--AFP.webp" 
                                                alt="Zavojna pumpa - serija: AFP"
                                            >
                                        </div>
                                ...
                                <div class="table-and-image__inner">
                                    ...
                                    <div class="image-container">
                                        <div class="image-box shadow">
                                            <img width="240" 
                                                height="240" 
                                                src="assets/img/pump-list/vertikalne/zavojna--SEFBP.webp" 
                                                alt="Zavojna pumpa - serija: SEFBP"
                                            >
                                        </div>
                                    </div> <!-- Image container end -->
                                ...
                                <div class="table-and-image__inner">
                                    ...
                                    <div class="image-container">
                                        <div class="image-box shadow">
                                            <img width="240" 
                                                height="240" 
                                                src="assets/img/pump-list/vertikalne/zavojna--SETP.webp" 
                                                alt="Zavojna pumpa - serija: SETP"
                                            >
                                        </div>
                                    </div> <!-- Image container end -->
                                ...
                                <div class="table-and-image__inner">
                                    ...
                                    <div class="image-container">
                                        <div class="image-box shadow">
                                            <img width="240" 
                                                height="240" 
                                                src="assets/img/pump-list/vertikalne/zavojna--SETBP.webp" 
                                                alt="Zavojna pumpa - serija: SETBP"
                                            >
                                        </div>
                                    </div> <!-- Image container end -->
