                ...
                <div class="container-fluid">
                    <div class="wrapper">
                        <div class="container container-medium-narrow">
                            ...
                            <!-- Section decoration -->
                            <img class="decoration dozirne-pumpe" src="assets/img/decorations/decoration--dozirne-pumpe.webp" alt="Dozirne pumpe" width="648" height="319">

                            <!-- Text and heading inner start -->
                            <div class="text-and-heading__inner">

                                <div class="title">
                                    <h1>Zavojne pumpe - dozirne</h1>    
                                </div>
                            ...
                            <div class="table-and-image__inner">
                                ...
                                <div class="image-container">
                                    <div class="image-box shadow">
                                        <img width="240" 
                                            height="240" 
                                            src="assets/img/pump-list/dozirne/dozirne-ALLCLEAN-ADP.webp" 
                                            alt="Dozirne pumpe ALLCLEAN-ADP"
                                        >
                                    </div>
                            ...
                            <div class="table-and-image__inner">
                                ...
                                <div class="image-container">
                                    <div class="image-box shadow">
                                        <img width="240" 
                                            height="240" 
                                            src="assets/img/pump-list/dozirne/dozirne-ADBP.webp" 
                                            alt="Dozirne pumpe ADBP"
                                        >
                                    </div>
                                </div> <!-- Image container end -->
