...
<body>
    ...
    <div class="page-warpper">
        ...
        <main>
            ...
            <!-- Page header start -->
            <section class="page-header page-header-bg--preuzmi">
                            ...
                            <div class="text-and-image__inner">
                                ...
                                <div class="image">
                                    <div class="image__inner">
                                        <img width="648" height="1037" src="assets/img/corporate/preuzmi-nerdjajuci-celici.jpg" alt="Nerdjajuci celici">
                                    </div>
                                </div> <!-- Image end -->
                    ...
                    <div class="wrapper">
                        <div class="container">
                            ...
                            <div class="text-and-image__inner">
                                ...
                                <div class="image">
                                    <div class="image__inner">
                                        <img width="648" height="411" src="assets/img/corporate/preuzmi-inox-ograde.jpg" alt="Inox ograde">
                                    </div>
                                </div> <!-- Image end -->
